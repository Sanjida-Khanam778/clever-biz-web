...
import { ScreenRestaurantReservationsWithGraph } from "./pages/restaurant/screen_restaurant_reservations-with-graph";
  ...
  return (
    <Routes>
      ...
      <Route path="/restaurant" element={<RestaurantLayout />}>
        ...
        {/* <Route
          path="reservations"
          element={<ScreenRestaurantReservationsWithGraph />}
        /> */}
