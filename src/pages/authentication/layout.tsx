...
const Layout = () => {
  return (
    <div className="bg-primary h-full min-h-screen flex flex-col">
      {/* Header */}
      <header className="container-header flex justify-between items-center p-6">
        <Link to="/">
          <Logo />
        </Link>
        <div>
          <Link to="/login" className="button-landing py-4">
            Login
          </Link>
        </div>
      </header>
      ...
      <footer className="container-header py-2 bg-footer text-white">
        <div className="grid grid-cols-2 md:grid-cols-3 items-center gap-y-4 md:gap-y-0 px-4">
          ...
          {/* privacy rich text */}
          <div className="col-span-2 md:col-span-1 order-3 md:order-none flex justify-center"></div>
